...
import heroImg from "../public/img/life1.jpg";
import Cta from "./cta";
    ...
    <>
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8 text-center lg:text-left">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-4xl xl:leading-tight dark:text-white">
              Welcome to Lifecard Co-Investment
            </h1>
            <h3 className="text-2xl font-bold leading-snug tracking-tight text-gray-800 lg:text-2xl lg:leading-tight xl:text-4xl xl:leading-tight dark:text-white">
              Unlock Profitable Real Estate Opportunities Together
            </h3>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
              At Lifecard International Investment, we believe that real estate
              investments should be accessible, collaborative, and rewarding for
              everyone. Lifecard Co-investment is a dynamic platform that opens
              doors to real estate investment opportunities for a broader
              audience, by bringing together various credible individuals with
              good credit standing to pull funds together to buy a property or
              properties.
            </p>

            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
              It is designed to make real estate investing more accessible,
              affordable, and less risky for individuals looking to grow their
              wealth through property. At lifecard we have made Investing in
              real estate easy and accessible. With our Co-investment, you can
              take the steps toward achieving your financial goals while
              benefiting from the stability and potential returns of the real
              estate market.
            </p>
            <div className="flex flex-col items-center text-center sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="/"
                target="_blank"
                rel="noopener"
      ...
      <Container>
        <div className="flex flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-indigo-600 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl">
          <div className="flex-grow text-center lg:text-left">
            <h2 className="text-2xl font-medium lg:text-3xl">
              We have curated a training for you.
            </h2>
            <p className="mt-2 font-medium text-white text-opacity-90 lg:text-md">
              Get first hand insights into international co-investment
              opportunities.
            </p>
          </div>
        ...
        {/* <p className="text-xl text-center text-gray-700 dark:text-white">
            We have curated a training for you. Get first hand insights into
            international co-investment opportunities.
          </p> */}

        {/* <a>
            <button>Click here Download</button>
          </a> */}
      </Container>
    </>
  );
